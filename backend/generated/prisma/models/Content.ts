...
export type ContentWhereInput = {
  ...
  value?: Prisma.StringFilter<"Content"> | string
...
export type ContentScalarWhereWithAggregatesInput = {
  ...
  value?: Prisma.StringWithAggregatesFilter<"Content"> | string
...
export type ContentOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"key" | "value" | "type", ExtArgs["result"]["content"]>
...
export interface ContentDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `key`
   * const contentWithKeyOnly = await prisma.content.findMany({ select: { key: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Contents and only return the `key`
   * const contentWithKeyOnly = await prisma.content.createManyAndReturn({
   *   select: { key: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Contents and only return the `key`
   * const contentWithKeyOnly = await prisma.content.updateManyAndReturn({
   *   select: { key: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface ContentFieldRefs {
  ...
  readonly value: Prisma.FieldRef<"Content", 'String'>
